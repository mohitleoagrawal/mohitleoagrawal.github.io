...
### Proposal
Having reached here, I recalled a design from university group project days. This design lets us increase number of booths without physically increasing width of the road.

<p align="center">
<img src="/images/posts/2018-01-29/tollbooth.gif" alt="title image" width="500" align="center"/> 
</p>
Check out the purple ball which is at 4th and 8th in single and double-booth lanes and crosses the booth in the same time
So this is about making one lane as multi booth by processing multiples vehicles in a go and effectively making number of booths incease to double. One drawback that we could think of this design it might be confusing for users in case where there is no waiting time display placed. They have to predict and go to the fastest lane which can cause a commotion. 
